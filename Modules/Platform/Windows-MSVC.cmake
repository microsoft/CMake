...
macro(__windows_compiler_msvc lang)
  ...
  if("x${lang}" STREQUAL "xC" OR
    ...
    if(CMAKE_VS_PLATFORM_TOOLSET MATCHES "v[0-9]+_clang_.*")
      ...
      # Exclude /Ob1 and /Ob2 (inline expansion) for clang with 32-bit output as it breaks printf as of clang-cl 7.0.1 with 16.1 STL
      if(CMAKE_CL_64 OR "x${CMAKE_C_COMPILER_ID}" STREQUAL "xMSVC" OR "x${CMAKE_CXX_COMPILER_ID}" STREQUAL "xMSVC")
        ...
        string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " /MD /O2 /Ob0 /DNDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " /MD /Zi /O2 /Ob0 /DNDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " /MD /O1 /Ob0 /DNDEBUG")
      endif()
    endif()
  endif()
